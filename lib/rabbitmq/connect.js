...
const RabbitmqConnectionKlass = function(configStrategy, instanceComposer) {
  ...
  oThis.connectionTtlSeconds = configStrategy.connectionTtlSeconds;
};
...
RabbitmqConnectionKlass.prototype = {
  ...
  set: function() {
    ...
    return new Promise(function(onResolve, onReject) {
      ...
      connectRmqInstance();
      setTimeout(function() {
        timedOutReason = 'Connection timed out fof rmqId:' + oThis.rmqId;
        connectRmqInstance();
      }, oThis.connectionTtlSeconds * 1000);
    });
  }
};
